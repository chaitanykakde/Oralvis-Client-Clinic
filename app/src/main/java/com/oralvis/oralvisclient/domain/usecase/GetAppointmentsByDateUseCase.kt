...
class GetAppointmentsByDateUseCase(private val clinicRepository: ClinicRepository) {

    suspend operator fun invoke(clinicId: String, date: String): ApiResult<List<Booking>> =
        clinicRepository.getBookingsByDate(clinicId, date)
}
